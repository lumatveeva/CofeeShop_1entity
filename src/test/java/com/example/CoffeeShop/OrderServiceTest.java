...
public class OrderServiceTest {
    ...
    public void deliveryFromCancelledOrderTest() throws IOException {
        ...
        when(orderService.findOrder(anyInt())).thenReturn(orderByCancelledState);
    ...
    public void acceptFromDeliveredOrderTest() throws IOException {
        ...
        when(orderService.findOrder(anyInt())).thenReturn(orderByDeliveredState);
        assertThrows(InvalidOrderStateException.class, () ->
    ...
    public void readyToBeDeliveredFromRegisterOrderTest() throws IOException {
        ...
        when(orderService.findOrder(anyInt())).thenReturn(orderByRegisterState);
        assertThrows(InvalidOrderStateException.class, () ->
