...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderServiceImpl(EventService eventService) {
    ...
    public void publishEvent(OrderEvent event) {
        ...
        log.info("Событие заказа с id " + event.getOrderId() + " сохранено");
    }
    ...
    public Order findOrder(int id) {
        return eventService.getOrderByOrderId(id);
    }
    ...
    public List<OrderEvent> findEventsByOrderId(int id) {
        ...
        log.info("Поиск всех событие по заказу с id" + id + " осуществлен");
    ...
    public List<Order> findAllOrder() {
        log.info("Поиск всех заказов");
        return eventService.findAllOrder();
    }
}
